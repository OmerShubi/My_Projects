...
if __name__ == '__main__':
    ...
    classifierKNN = AlgorithmRunner.AlgorithmRunner('KNN')
    classifierRocchio = AlgorithmRunner.AlgorithmRunner('Rocchio')
    ...
    print("Question 1:")
    print("KNN classifier {:.2f}".format(KNN_precision/5, KNN_recall/5, KNN_accuracy/5))
