...
tic;
% ***  Part 1  ***
[~ ,x_1,x_10,x_100,x_1000] = generic_grad(f, g, exact_quad(Y), x0,1000);
toc
...
L = 2*max(eigs(Y1));
tic;
[~ ,x_1,x_10,x_100,x_1000] = generic_grad(f, g, const_step(1/L), x0, 1000);
toc
...
[x_fista,fs_fista,gs_fista,ts_fista] = fista(f, g, L, x0, 1000);
